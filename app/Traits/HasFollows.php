...
trait HasFollows
{
    ...
    {
        return $this->belongsToMany(User::class, 'forum_follows', 'user_id', 'following_user_id')->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany(User::class, 'forum_follows', 'following_user_id', 'user_id')->withTimestamps();
    }
